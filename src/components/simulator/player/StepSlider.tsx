            ...
            <div className="relative h-full lg:pt-6 lg:ml-32">
                ...
                <Slider
                    ...
                    className={cn(
                        ...
                        '[&_[role=slider]]:before:h-0',
                        '[&_[role=slider]]:before:border-l-[6px]',
                        '[&_[role=slider]]:before:border-r-[6px]',
                        ...
                        '[&_[role=slider]]:after:h-0',
                        '[&_[role=slider]]:after:border-l-[6px]',
                        '[&_[role=slider]]:after:border-r-[6px]',
